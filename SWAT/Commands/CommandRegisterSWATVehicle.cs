...
namespace S1thK3nny.SWAT.Commands
{
    public class CommandRegisterSWATVehicle : IRocketCommand
    {
        ...
        public void Execute(IRocketPlayer caller, string[] command)
        {
            ...
            Console.WriteLine($"[SWATPlugin] Registered SWAT vehicle {payload.VehicleID} at position {payload.SpawnPosition} on map {mapId}.");
            ChatHelper.SendTo(caller, "CommandRegisterSWATVehicleSaved", ChatLevel.OK, new[] { Convert.ToString(payload.VehicleID), mapId });
        }
